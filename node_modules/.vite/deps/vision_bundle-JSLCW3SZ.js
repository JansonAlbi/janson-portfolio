...
var D = class {
  constructor(t2, e2) {
    if (C(e2), this.ba = t2, null != t2 && 0 === t2.length)
...
function lt(t2, e2, n2) {
  if (null != t2) {
    if ("string" == typeof t2)
      t2 = t2 ? new D(t2, P) : N();
    else if (t2.constructor !== D)
      if (I(t2))
        t2 = t2.length ? new D(n2 ? t2 : new Uint8Array(t2), P) : N();
      else {
        if (!e2)
          throw Error();
        t2 = void 0;
...
function Gt(t2, e2) {
  if (t2 >>>= 0, (e2 >>>= 0) <= 2097151)
    ...
    X() ? n2 = "" + (BigInt(e2) << BigInt(32) | BigInt(t2)) : (t2 = (16777215 & t2) + 6777216 * (n2 = 16777215 & (t2 >>> 24 | e2 << 8)) + 6710656 * (e2 = e2 >> 16 & 65535), n2 += 8147497 * e2, e2 *= 2, t2 >= 1e7 && (n2 += t2 / 1e7 >>> 0, t2 %= 1e7), n2 >= 1e7 && (e2 += n2 / 1e7 >>> 0, n2 %= 1e7), n2 = e2 + jt(n2) + jt(t2));
  return n2;
}
function jt(t2) {
...
function Vt(t2) {
  if (t2.length < 16)
    ...
    t2 = BigInt(t2), Pt = Number(t2 & BigInt(4294967295)) >>> 0, Ot = Number(t2 >> BigInt(32) & BigInt(4294967295));
  else {
    const e2 = +("-" === t2[0]);
    Ot = Pt = 0;
    const n2 = t2.length;
...
function Zt(t2) {
  ...
  if (Number.isSafeInteger(e2))
    return String(e2);
  if (-1 !== (e2 = t2.indexOf(".")) && (t2 = t2.substring(0, e2)), !("-" === t2[0] ? t2.length < 20 || 20 === t2.length && Number(t2.substring(0, 7)) > -922337 : t2.length < 19 || 19 === t2.length && Number(t2.substring(0, 6)) < 922337))
    if (Vt(t2), t2 = Pt, 2147483648 & (e2 = Ot))
      if (X())
...
function te(t2) {
  ...
  var e2 = typeof t2;
  if ("bigint" === e2)
    return String(BigInt.asUintN(64, t2));
  if (Kt(t2)) {
    if ("string" === e2)
      return e2 = Math.trunc(Number(t2)), Number.isSafeInteger(e2) && e2 >= 0 ? t2 = String(e2) : (-1 !== (e2 = t2.indexOf(".")) && (t2 = t2.substring(0, e2)), qt(t2) || (Vt(t2), t2 = Gt(Pt, Ot))), t2;
    if ("number" === e2)
      return (t2 = Math.trunc(t2)) >= 0 && Number.isSafeInteger(t2) ? t2 : function(t3) {
        if (t3 < 0) {
          Nt(t3);
          const e3 = Gt(Pt, Ot);
...
function ie(t2, e2, n2, r2) {
  if (null != t2 && "object" == typeof t2 && t2.Y === at)
    return t2;
  if (!Array.isArray(t2))
    return n2 ? 2 & r2 ? (t2 = e2[Y]) ? e2 = t2 : (rt((t2 = new e2()).u), e2 = e2[Y] = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = tt(t2);
      ...
      switch (typeof e2) {
        ...
        case "bigint":
          if (t2 = e2 = BigInt.asIntN(64, e2), Tt(t2)) {
            if (!/^\s*(?:-?[1-9]\d*|0)?\s*$/.test(t2))
              throw Error(String(t2));
          } else if (wt(t2) && !Number.isSafeInteger(t2))
            throw Error(String(t2));
...
function Ee(t2, e2) {
  ...
  for (const i2 in e2) {
    var n2, r2 = Number(i2);
    if ((n2 = Number.isInteger(r2)) && (n2 = t2[r2], r2 = e2[r2], n2 = !(Number.isNaN(n2) ? Number.isNaN(r2) : n2 === r2)), n2)
      return false;
  }
  return true;
}
  ...
  if (t2 && (fe == null ? void 0 : fe.has(t2))) {
    ...
    if (e2)
      for (let n2 = 0; n2 < e2.length; n2++) {
        const r2 = e2[n2];
        if (n2 === e2.length - 1 && ut(r2))
          for (const e3 in r2) {
            const n3 = r2[e3];
            Array.isArray(n3) && ve(n3, t2);
          }
        else
          Array.isArray(r2) && ve(r2, t2);
      }
  }
}
function Te(t2, e2) {
...
function be(t2, e2, n2) {
  if (null == t2 && (t2 = de), de = void 0, null == t2) {
    ...
    t: {
      ...
      if (e2) {
        if ((e2 = Math.max(e2, i2 - (+!!(512 & r2) - 1))) > 1024)
          throw Error("spvt");
        r2 = -33521665 & r2 | (1023 & e2) << 15;
      }
    }
...
function Ue(t2, e2, n2, r2, i2) {
  if (null != t2) {
    if (Array.isArray(t2))
      t2 = ft(t2) ? void 0 : i2 && 2 & tt(t2) ? t2 : De(t2, e2, n2, void 0 !== r2, i2);
    else if (ut(t2)) {
      const s2 = {};
      for (let o2 in t2)
        s2[o2] = Ue(t2[o2], e2, n2, r2, i2);
      t2 = s2;
    } else
      t2 = e2(t2, r2);
    return t2;
...
function Ke(t2, e2, n2, r2) {
  if (!((e2 = r2 + (+!!(512 & e2) - 1)) < 0 || e2 >= t2.length || e2 >= n2))
    return t2[e2];
}
...
function cn(t2) {
  if (W)
    return t2[q] ?? (t2[q] = /* @__PURE__ */ new Map());
  if (q in t2)
    return t2[q];
...
function fn(t2, e2, n2, r2) {
  let i2, s2 = et(t2);
  if (null != (r2 = Ye(t2, s2, n2, r2)) && r2.Y === at)
    return (e2 = He(r2)) !== r2 && qe(t2, s2, n2, e2), e2.u;
  if (Array.isArray(r2)) {
    const t3 = tt(r2);
...
function gn(t2, e2, n2, r2, i2, s2, o2) {
  ...
  if (o2 && !(8 & c2 || !h2.length && (1 === i2 || 4 === i2 && 32 & c2))) {
    for (sn(c2) ? (h2 = H(h2), c2 = vn(c2, e2), e2 = qe(a2, e2, r2, h2)) : Te(h2, t2), n2 = h2, o2 = c2, l2 = 0; l2 < n2.length; l2++)
      (c2 = n2[l2]) !== (f2 = He(c2)) && (n2[l2] = f2);
...
function On(t2) {
  if ("string" == typeof t2)
    return { buffer: M(t2), O: false };
  if (Array.isArray(t2))
    return { buffer: new Uint8Array(t2), O: false };
  if (t2.constructor === Uint8Array)
    return { buffer: t2, O: false };
  if (t2.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(t2), O: false };
  if (t2.constructor === D)
    return { buffer: U(t2) || new Uint8Array(0), O: true };
  if (t2 instanceof Uint8Array)
    return { buffer: new Uint8Array(t2.buffer, t2.byteOffset, t2.byteLength), O: false };
...
function Cn(t2, e2) {
  ...
  for (s2 > 32 && (i2 |= (127 & n2) >> 4), s2 = 3; s2 < 32 && 128 & n2; s2 += 7)
...
function $n(t2, e2, n2) {
  ...
  let o2 = s2 - r2;
  if (o2 <= 0 && (t2.g.l = s2, n2(e2, t2, void 0, void 0, void 0), o2 = s2 - t2.g.g), o2)
    ...
    if (c2) {
      ...
      if (r2) {
        t: {
          ...
          if (o2)
            for (let t3 in o2)
              isNaN(+t3) ? (s2 ?? (s2 = {}))[t3] = o2[t3] : (r2 = o2[t3], Array.isArray(r2) && (ft(r2) || ct(r2) && 0 === r2.size) && (r2 = null), null == r2 && (a2 = true), null != r2 && ((s2 ?? (s2 = {}))[t3] = r2));
          if (a2 || (s2 = o2), s2)
            for (let t3 in s2) {
              a2 = s2;
              break t;
      ...
      for (; c2 > 0 && (null == (s2 = i2[c2 - 1]) || ft(s2) || ct(s2) && 0 === s2.size); c2--)
        var h2 = true;
...
function Br(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (let t3 in r2)
      i2 = +t3, !Number.isNaN(i2) && (null != (s2 = r2[t3]) && (a2 = Dr(n2, i2))) && (((_b = o2 = n2.X) == null ? void 0 : _b[i2]) && !((_c = o2 == null ? void 0 : o2.P) == null ? void 0 : _c[i2]) && Wr++ < 5 && j(), a2(e2, s2, i2));
  }
  if (t2 = mt ? t2[mt] : void 0)
    for (pr(e2, e2.g.end()), n2 = 0; n2 < t2.length; n2++)
      pr(e2, U(t2[n2]) || new Uint8Array(0));
}
function Gr(t2, e2) {
...
function zr(t2, e2, n2) {
  if (e2 = function(t3) {
    ...
    const e3 = typeof t3;
    if ("bigint" === e3)
      return String(BigInt.asIntN(64, t3));
    if (Kt(t3)) {
      if ("string" === e3)
        return Zt(t3);
      if ("number" === e3)
  ...
  g() {
    ...
    return t2 = function(t3, e3, n3) {
      ...
      if (null == n3) {
        ...
        Array.isArray(n3) ? s2 = !!(2 & tt(n3)) : n3 = [];
      if (i2) {
        if (!n3.length)
          return Ne();
        s2 || (s2 = true, rt(n3));
      } else
        s2 && (s2 = false, n3 = on(n3));
...
function Lo(t2) {
  ...
  if ((e2 = (_a2 = pn(t2, is, 4)) == null ? void 0 : _a2.h()) && (s2.boundingBox = { originX: An(e2, 1) ?? 0, originY: An(e2, 2) ?? 0, width: An(e2, 3) ?? 0, height: An(e2, 4) ?? 0, angle: 0 }), (_b = pn(t2, is, 4)) == null ? void 0 : _b.g().length)
    for (const e3 of pn(t2, is, 4).g())
      s2.keypoints.push({ x: Ze(e3, 1) ?? 0, y: Ze(e3, 2) ?? 0, score: Ze(e3, 4) ?? 0, label: re(ze(e3, 3)) ?? "" });
  return s2;
}
function Ro(t2) {
  const e2 = [];
  for (const n2 of mn(t2, hs, 1))
    e2.push({ x: bn(n2, 1) ?? 0, y: bn(n2, 2) ?? 0, z: bn(n2, 3) ?? 0, visibility: bn(n2, 4) ?? 0 });
  return e2;
}
function Fo(t2) {
  const e2 = [];
  for (const n2 of mn(t2, os, 1))
    e2.push({ x: bn(n2, 1) ?? 0, y: bn(n2, 2) ?? 0, z: bn(n2, 3) ?? 0, visibility: bn(n2, 4) ?? 0 });
  return e2;
}
function Mo(t2) {
...
async function zo(t2, e2, n2, r2) {
  return t2 = await (async (t3, e3, n3, r3, i2) => {
    if (e3 && await Bo(e3), !self.ModuleFactory)
      throw Error("ModuleFactory not set.");
    if (n3 && (await Bo(n3), !self.ModuleFactory))
      throw Error("ModuleFactory not set.");
...
var Qo = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c = pn(this.baseOptions, Ss, 1)) == null ? void 0 : _c.g()) || ((_d = pn(this.baseOptions, Ss, 1)) == null ? void 0 : _d.h()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath)))
...
Qo.prototype.close = Qo.prototype.close, function(e2, n2) {
  ...
  for (; e2.length && (r2 = e2.shift()); )
    e2.length || void 0 === n2 ? i2 = i2[r2] && i2[r2] !== Object.prototype[r2] ? i2[r2] : i2[r2] = {} : i2[r2] = n2;
}("TaskRunner", Qo);
var ea = class {
...
function na(t2, e2, n2) {
  const r2 = t2.g;
  if (n2 = ta(r2.createShader(n2), "Failed to create WebGL shader"), r2.shaderSource(n2, e2), r2.compileShader(n2), !r2.getShaderParameter(n2, r2.COMPILE_STATUS))
...
var ca = class {
  ...
  m() {
    const t2 = this.g;
    if (this.h = ta(t2.createProgram(), "Failed to create WebGL program"), this.da = na(this, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", t2.VERTEX_SHADER), this.ca = na(this, this.H(), t2.FRAGMENT_SHADER), t2.linkProgram(this.h), !t2.getProgramParameter(this.h, t2.LINK_STATUS))
...
var Ia = class {
  ...
  Ca(t2, e2) {
    if (t2) {
      ...
      for (const s2 of t2)
        n2.fillStyle = ka(e2.fillColor, { index: i2, from: s2 }), n2.strokeStyle = ka(e2.color, { index: i2, from: s2 }), n2.lineWidth = ka(e2.lineWidth, { index: i2, from: s2 }), (t2 = new Path2D()).arc(s2.x * r2.width, s2.y * r2.height, ka(e2.radius, { index: i2, from: s2 }), 0, 2 * Math.PI), n2.fill(t2), n2.stroke(t2), ++i2;
      n2.restore();
    }
  }
  Ba(t2, e2, n2) {
...
var Za = class extends Qo {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && Sn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas)
...
var Qa = class extends Za {
  ...
  m() {
    ...
    Bi(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect_in"), ji(n2, "DETECTIONS:detections"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("detections", (t3, e3) => {
      for (const e4 of t3)
        t3 = ss(e4), this.j.detections.push(Lo(t3));
      $o(this, e3);
...
var lh = class extends Za {
  ...
  m() {
    ...
    Bi(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = cs(e4), this.j.faceLandmarks.push(Ro(t3));
      $o(this, e3);
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = es(e4), this.j.faceBlendshapes.push(xo(t3.g() ?? []));
      $o(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = pn(Cs(e4), us, 2)) && this.j.facialTransformationMatrixes.push({ rows: Tn(An(t3, 1), 0) ?? 0, columns: Tn(An(t3, 2), 0) ?? 0, data: en(t3, 3, Ht, tn()).slice() ?? [] });
      $o(this, e3);
...
var fh = class extends Za {
  ...
  Ra(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, $a(this, t2, r2 ?? {}), !this.h)
      return this.s;
  }
  m() {
    var t2 = new $i();
...
function mh(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != An(n3, 1) ? Tn(An(n3, 1), 0) : -1, t2.push({ score: bn(n3, 2) ?? 0, index: r2, categoryName: kn(n3, 3) ?? "", displayName: kn(n3, 4) ?? "" });
    n2.push(t2);
  }
  return n2;
}
var yh = class extends Za {
  ...
  o(t2) {
    ...
    if (xn(this.v, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.v, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.s, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.C, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && ((_b = pn(this.h, Hs, 3)) == null ? void 0 : _b.g());
  ...
  m() {
    ...
    Bi(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "HAND_GESTURES:hand_gestures"), ji(n2, "LANDMARKS:hand_landmarks"), ji(n2, "WORLD_LANDMARKS:world_hand_landmarks"), ji(n2, "HANDEDNESS:handedness"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) {
        t3 = cs(e4);
        const n3 = [];
        for (const e5 of mn(t3, hs, 1))
          n3.push({ x: bn(e5, 1) ?? 0, y: bn(e5, 2) ?? 0, z: bn(e5, 3) ?? 0, visibility: bn(e5, 4) ?? 0 });
...
var vh = class extends Za {
  ...
  m() {
    ...
    Bi(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "LANDMARKS:hand_landmarks"), ji(n2, "WORLD_LANDMARKS:world_hand_landmarks"), ji(n2, "HANDEDNESS:handedness"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = cs(e4), this.landmarks.push(Ro(t3));
      $o(this, e3);
    }), this.g.attachEmptyPacketListener("hand_landmarks", (t3) => {
      $o(this, t3);
    }), this.g.attachProtoVectorListener("world_hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = as(e4), this.worldLandmarks.push(Fo(t3));
      $o(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      $o(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({ score: bn(e5, 2) ?? 0, index: Tn(An(e5, 1), 0) ?? -1, categoryName: kn(e5, 3) ?? "", displayName: kn(e5, 4) ?? "" });
        i2.push(n4);
      }
...
var bh = class extends Za {
  ...
  m() {
    ...
    an(n2, 1, ne("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), ""), function(t3, e3) {
      if (null != e3)
        if (Array.isArray(e3))
          $e(t3, 2, De(e3, Ge, void 0, void 0, false));
        else {
          if (!("string" == typeof e3 || e3 instanceof D || I(e3)))
    ...
    Bi(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), zi(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = vs(t3), this.embeddings = function(t4) {
        return { embeddings: mn(t4, ys, 1).map((t5) => {
          ...
          if (void 0 !== dn(t5, gs, hn(t5, 1)))
            t5 = en(t5 = pn(t5, gs, hn(t5, 1)), 1, Ht, tn()), e4.floatEmbedding = t5.slice();
          else {
...
Sh.cosineSimilarity = function(t2, e2) {
  if (t2.floatEmbedding && e2.floatEmbedding)
    t2 = Io(t2.floatEmbedding, e2.floatEmbedding);
  else {
...
var Xh = class extends Za {
  ...
  ha(t2, e2, n2, r2) {
    ...
    const s2 = new Gh();
    var o2 = new Ih();
    if (xn(o2, 1, 255), yn(s2, 0, 12, o2), e2.keypoint && e2.scribble)
    ...
    if (e2.keypoint) {
      ...
      for (a2 of (o2 = new Bh(), e2.scribble))
        Sn(e2 = new Uh(), 3, true), Ln(e2, 1, a2.x), Ln(e2, 2, a2.y), wn(o2, 1, Uh, e2);
      _n(s2, 15, jh, o2);
    }
...
//# sourceMappingURL=vision_bundle-JSLCW3SZ.js.map
